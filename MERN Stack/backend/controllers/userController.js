...
exports.logout = catchAsynchErrors(async(req,res,next)=>{
...
// Get User Details
exports.getUserDetails = catchAsynchErrors(async(req,res,next)=>{
...
exports.updatePassword = catchAsynchErrors(async(req,res,next)=>{
    ...
    user.password = newPassword = req.body.newPassword;
